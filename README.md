<section id="documentation-types" style="font-family: sans-serif; line-height: 1.6; max-width: 800px; margin: 0 auto; padding: 20px;">
  ...
  <p style="margin-bottom: 20px;">This repository organizes writing samples that demonstrate my technical writing abilities. Check back frequently for new project commits.</p>
